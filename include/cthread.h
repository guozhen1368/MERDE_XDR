...
extern DLL_APP void *thread_open(LPTHREAD_START_ROUTINE thrfunc, LPVOID arg);
extern DLL_APP void thread_close(void *hd);
extern DLL_APP int thread_set_concurrency(int newlevel);
