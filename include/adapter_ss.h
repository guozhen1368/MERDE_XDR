...
DLL_APP void *adapter_register_ss(unsigned long cfghd, char *section,
		int (*running)(void));
DLL_APP void *adapter_register_ss_cfgfile(char *cfgfile, char *section,
		int (*running)(void));
DLL_APP void *adapter_register_ss_cfgstr(char *cfgstr, char *section,
		int (*running)(void));
...
/* These two functions must be called after adapter_register_ss* and
 * before adapter_open.
 */
...
DLL_APP void adapter_ss_setstat(void *adap, CSSOCK_STAT_CB statcb, void *arg);
