...
#else
#define SLEEP_US(x) { \
	struct timeval nReplaceuSleeptv; \
	nReplaceuSleeptv.tv_sec = (x) / 1000000; \
	nReplaceuSleeptv.tv_usec = (x) % 1000000; \
	select(0, NULL, NULL, NULL, &nReplaceuSleeptv); \
}
#define SLEEP_MS(x) SLEEP_US((x) * 1000)
#endif
#endif
...
#define STRNCASECMP(caseSensitive, A, B, len) ((caseSensitive) ? strncmp((A), (B), (len)) : _strnicmp((A), (B), (len)))
#else
#define STRCASECMP(caseSensitive, A, B) ((caseSensitive) ? strcmp((A), (B)) : stricmp((A), (B)))
#define STRNCASECMP(caseSensitive, A, B, len) ((caseSensitive) ? strncmp((A), (B), (len)) : strnicmp((A), (B), (len)))
#endif
#else
#define STRCASECMP(caseSensitive, A, B) ((caseSensitive) ? strcmp((A), (B)) : strcasecmp((A), (B)))
#define STRNCASECMP(caseSensitive, A, B, len) ((caseSensitive) ? strncmp((A), (B), (len)) : strncasecmp((A), (B), (len)))
#endif
